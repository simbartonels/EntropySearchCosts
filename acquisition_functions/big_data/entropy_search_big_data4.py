...
class EntropySearchBigData4(EntropySearchBigData):
    def __init__(self, comp, vals, incumbent, gp, cost_gp=None):
        super(EntropySearchBigData4, self)._initialize(comp, vals, incumbent, gp, cost_gp)

    def _compute(self, kl, costs, candidate):
        '''
        Returns (kl - currentKL) / log(costs).
        Args:
        ...
        '''
        return (kl - self._current_kl) / np.log(costs)